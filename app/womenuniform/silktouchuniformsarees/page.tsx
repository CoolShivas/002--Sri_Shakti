...
const SilkTouchUniformSareesPage = () => {
  ...
  // ✅ Fixed: use exact API values for filtering
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(
      state,
      "Womens", // must match API's `uniformType`
      "Silk Touch Uniform Sarees" // must match API's `uniformSubtype`
    )
  );
            ...
            <div className="md:col-span-3">
              {isLoading && (
                <div className="py-10 text-center text-3xl font-bold">
                  Loading Silk Touch Uniform Sarees...
                </div>
              )}
              {error && (
                ...
                {uniforms.length > 0
                  ...
                  : !isLoading && (
                      <p className="text-center text-gray-500 text-2xl font-semibold">
                        No Silk Touch Uniform Sarees found.
                      </p>
                    )}
              </div>
            </div>
...
export default SilkTouchUniformSareesPage;
