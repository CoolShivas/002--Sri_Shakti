...
const StaffUniformSareesPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Staff Uniform Sarees")
  );
...
export default StaffUniformSareesPage;
