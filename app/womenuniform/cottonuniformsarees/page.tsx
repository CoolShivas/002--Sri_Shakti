...
const CottonUniformSareesPage = () => {
  ...
  // ✅ Strict filter: uniformType + uniformSubtype
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Cotton Uniform Sarees")
  );
                ...
                {uniforms && uniforms.length > 0
                  ...
                  : !isLoading && (
                      <p className="text-center text-gray-500 text-2xl font-semibold">
                        No Cotton Uniform Sarees found.
                      </p>
                    )}
              </div>
            </div>
...
export default CottonUniformSareesPage;
