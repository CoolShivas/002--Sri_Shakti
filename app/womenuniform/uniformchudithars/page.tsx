...
const UniformChuditharsPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Uniform Chudithars")
  );
...
export default UniformChuditharsPage;
