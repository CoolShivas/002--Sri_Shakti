...
const TeachersUniformSareesPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Teachers Uniform Sarees")
  );
            ...
            <div className="md:col-span-3">
              {isLoading && (
                <div className="py-10 text-center text-3xl font-bold">
                  Loading Teachers Uniform Sarees...
                </div>
              )}
              {error && (
                ...
                {uniforms.length > 0
                  ...
                  : !isLoading && (
                      <p className="text-center text-gray-500 text-2xl font-semibold">
                        No Teachers Uniform Sarees found.
                      </p>
                    )}
              </div>
            </div>
...
export default TeachersUniformSareesPage;
