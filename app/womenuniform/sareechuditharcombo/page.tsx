...
const SareeChuditharComboPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Saree Chudithar Combo")
  );
            ...
            <div className="md:col-span-3">
              {isLoading && (
                <div className="py-10 text-center text-3xl font-bold">
                  Loading Saree Chudithar Combo uniforms...
                </div>
              )}
              {error && (
                ...
                {uniforms.length > 0
                  ...
                  : !isLoading && (
                      <p className="text-center text-gray-500 text-2xl font-semibold">
                        No Saree Chudithar Combo found.
                      </p>
                    )}
              </div>
            </div>
...
export default SareeChuditharComboPage;
