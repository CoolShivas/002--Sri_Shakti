...
const PlainUniformSareesPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Womens", "Plain Uniform Sarees")
  );
...
export default PlainUniformSareesPage;
