...
const UniformPantsPage = () => {
  ...
  // ✅ Filter Mens + Uniform Pants
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Mens", "Uniform Pants")
  );
...
export default UniformPantsPage;
