...
const UniformBlazersPage = () => {
  ...
  // ✅ Filter Mens + Uniform Blazers
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Mens", "Uniform Blazers")
  );
...
export default UniformBlazersPage;
