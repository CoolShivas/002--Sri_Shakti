...
const UniformTShirtsPage = () => {
  ...
  // ✅ Filter Mens + Uniform T-Shirts
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Mens", "Uniform Tshirts")
  );
...
export default UniformTShirtsPage;
