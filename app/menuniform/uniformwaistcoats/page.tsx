...
const UniformWaistcoatsPage = () => {
  ...
  // ✅ Filter Mens + Uniform Waistcoats
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Mens", "Uniform Waist Coats")
  );
...
export default UniformWaistcoatsPage;
