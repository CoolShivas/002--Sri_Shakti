// // // Having Quick Links in sidebar in School Main Page.
...
//           {uniformTypes.map(({ subtype }) => (
//             <li key={subtype}>
//               <Link
//                 href={`/schooluniform/${subtype}schooluniform`}
//                 className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200"
//               >
//                 {subtype.charAt(0).toUpperCase() + subtype.slice(1)} Uniforms
//               </Link>
//             </li>
//           ))}
//         </ul>
...
// // // Not - Having Quick Links in sidebar in School Main Page.
