...
const CbseSchoolUniformPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "School", "CBSE School Uniforms")
  );
...
export default CbseSchoolUniformPage;
