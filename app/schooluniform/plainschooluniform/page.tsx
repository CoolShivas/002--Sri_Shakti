...
const PlainSchoolUniforms = () => {
  const dispatch = useDispatch();

  // school + cbse (case-insensitive, includes, with fallbacks if subtype missing)
  const uniforms =
    useSelector(selectUniformsByTypeAndSubtype("school", "plain")) || [];
    ...
    <section className="py-10">
      <div className="container">
        <h1 className="text-2xl md:text-3xl font-bold mb-6">
          Welcome to Plain School Uniforms Page.
        </h1>
...
export default PlainSchoolUniforms;
