...
const HospitalUniformPantPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Hospital", "Hospital Uniform Pants")
  );
...
export default HospitalUniformPantPage;
