...
const DoctorUniformSareePage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Hospital", "Doctor Uniform Sarees")
  );
...
export default DoctorUniformSareePage;
