...
const HospitalUniformShirtPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Hospital", "Hospital Uniform Shirts")
  );
            ...
            <div className="md:col-span-3">
              {isLoading && (
                <div className="py-10 text-center text-lg">
                  Loading hospital uniform shirts...
                </div>
              )}
              {error && (
...
export default HospitalUniformShirtPage;
