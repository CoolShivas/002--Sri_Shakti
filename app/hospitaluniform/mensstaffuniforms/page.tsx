...
const MensStaffUniformPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Hospital", "Mens Staff Uniforms")
  );
...
export default MensStaffUniformPage;
