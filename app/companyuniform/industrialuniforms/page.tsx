...
const IndustrialUniformsPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Company", "Industrial Uniforms")
  );
...
export default IndustrialUniformsPage;
