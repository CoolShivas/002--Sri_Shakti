...
const MechanicUniformPage = () => {
  ...
  const uniforms = useSelector((state: any) =>
    selectUniformsByTypeAndSubtype(state, "Company", "Mechanic Uniforms")
  );
...
export default MechanicUniformPage;
