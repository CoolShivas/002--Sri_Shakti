...
const categorySubpages = {
  ...
  hospitaluniform: [
    ...
    { label: "Doctor Saree", href: "/hospitaluniform/doctoruniformsarees" },
    { label: "Hospital Wear", href: "/hospitaluniform/hospitaluniforms" },
    { label: "Hospital Pants", href: "/hospitaluniform/hospitaluniformpants" },
    { label: "Hospital Saree", href: "/hospitaluniform/hospitaluniformsarees" },
    { label: "Men's Staff", href: "/hospitaluniform/mensstaffuniforms" },
    { label: "Hospital Shirt", href: "/hospitaluniform/hospitaluniformshirts" },
    { label: "Nurse Wear", href: "/hospitaluniform/nurseuniforms" },
    {
      label: "Operation Theatre",
      href: "/hospitaluniform/operationtheatreuniforms",
    },
    {
      label: "Staff Chudidhar",
      href: "/hospitaluniform/staffuniformchudidhars",
    },
  ],
  companyuniform: [
