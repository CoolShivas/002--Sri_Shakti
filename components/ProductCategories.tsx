...
const ProductCategories = () => {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-100 to-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {categories.map((category, index) => {
          const uniqueId = `IMG-${String(index + 1).padStart(3, "0")}`;
          return (
            <motion.div
              key={index}
              className="rounded-xl overflow-hidden shadow-lg bg-white hover:shadow-2xl transition duration-300"
            ...
            >
              <div className="relative h-48 sm:h-56 md:h-64">
                ...
                <div className="absolute top-2 right-2 z-10 bg-white/80 p-1 rounded-full shadow-md">
                  <Image
                ...
                {/* Unique ID overlay in bottom-right */}
